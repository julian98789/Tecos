                ...
                <form onSubmit={handleSubmit(enviarDatos)} className="w-[700px] bg-[rgba(17,17,16,0.92)] border  rounded-2xl  flex justify-center items-center flex-col space-y-6 ">
                    ...
                    <div className="w-[500px] flex flex-col  space-y-2">
                        ...
                        <div className="flex flex-row gap-5 justify-items-start pb-7">
                            ...
                            <div className=" flex items-center w-[240px] mb-7">
                        ...
                        <div className=" flex flex-row gap-5 ">
                            <div className="flex items-center ">
                                <button type="submit" className="bg-green-600 rounded-xl w-[240px] outline-none mb-7 h-9 pl-5 hover:bg-green-700 text-white text-center">Registrar</button>
                            </div>
                            <div className="flex items-center ">
                                <button onClick={cerrarFormulario} className="bg-red-600 rounded-xl w-[240px] outline-none mb-7 h-9 pl-5 hover:bg-red-700 text-white text-center">Cancelar</button>
                            </div>
                        </div>
                    </div>
